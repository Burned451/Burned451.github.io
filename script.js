...
function toggle_mobile_view(obj) {
  if($(obj).is(":checked")){
	...
	document.getElementById("mobile-wrapper").style.top = "50%";
	document.getElementById("mobile-wrapper").style.left = "50%";
	document.getElementById("mobile-wrapper").style.transform = "translate(-50%, -50%)";
	...
	document.getElementById("mobile-wrapper").style.top = "0";
	document.getElementById("mobile-wrapper").style.left = "0";
	document.getElementById("mobile-wrapper").style.transform = "translate(0, 0)";
